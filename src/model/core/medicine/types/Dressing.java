...
public class Dressing extends MedicineAbs {
    public Dressing(ECategory type, String name, String dateExpiration, String dateIntroduction, String description, int codeEan) {
        super(type, name, dateExpiration, dateIntroduction, description, codeEan);
    }

    public Dressing(ECategory type, String name, String dateIntroduction, String dateExpiration, int codeEan) {
